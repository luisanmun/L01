...
<acme:form>
	...
	<acme:form-textbox code="anonymous.bulletin.form.label.title" path="title"/>
	<acme:form-textarea code="anonymous.bulletin.form.label.body" path="body"/>

	<acme:form-submit code="anonymous.bulletin.form.button.create" action="/anonymous/callePerezBulletin/create"/>
